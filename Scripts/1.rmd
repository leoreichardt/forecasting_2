...
CA accounts for more than 40% of sales in the country, while TX stores are slightly under 30%. 
...
Note that not all products were on sale from January 2011, which is probably why 2011 is lower. 
...
Prices appear to be linear, with small variation over time. We cannot identify any particular trend. Average prices are lower at the beginning, but this is probably because not all products were sold from 2011. 
...
We have selected product "FOODS_3_794 to show the possible price variations over time. The three downward peaks are probably discounts or an error in the data.
...
Most events are national or religious events. It would be interesting to know what events happend during the 28 days that we have to predict. 
...
```
The linear regression of independence day on sales shows us that it does not have a significant impact. However, it will be interesting to set it as a factor in the time series to see if it increases the accuracy of our predictions. 