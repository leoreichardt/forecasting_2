...
Having to analyze the TX_1 store, we started by trying to modelize the sales of this store using all the level hierarchically bellow.  
We were soon confronted with the problems of the lack of power of our laptops. In fact, the bottom level accounts 3049 products which is too heavy.  
We decided to keep only the level above : store_id (= TX_1), cat_id and dept_id.
We included for the ARIMA models regressors to take into account the effect of Christmas and Independance day. This technique imporoved the metrics.  
...
Predictions seem to follow the fluctuations in actual sales well.  
