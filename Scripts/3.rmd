...
The following graph shows the predicted values in red and the actual values in black. 
Unfortunately, since we used the middle out method we were not able to add a confidence interval with the code provided. 
